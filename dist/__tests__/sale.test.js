...
describe("Sale API", () => {
    ...
    describe("POST /api/sales", () => {
        it("should create a new sale and update stock", async () => {
            ...
            const response = await (0, supertest_1.default)(app_1.default).post("/api/sales").send(saleData);
    ...
    describe("GET /api/sales/analytics", () => {
        it("should get sales analytics for a date range", async () => {
            ...
            const response = await (0, supertest_1.default)(app_1.default).get("/api/sales/analytics").query({
